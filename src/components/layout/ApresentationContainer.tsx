    ...
    <section id="home" className="flex flex-col h-screen w-full scroll-hidden">
      <div className="md:flex grow items-center justify-center mt-6 group scroll-hidden bg-amber-500 ">
        ...
        <div className="flex flex-col grow h-1/2 md:h-2/3 md:w-1/4 hover:w-full transition-all duration-500 scroll-hidden bg-white">
          ...
          >
            <div className="inline-block w-full md:w-10/12 h-full bg-red-500 rounded-full">1</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-blue-400 rounded-full">2</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-green-400 rounded-full">3</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-yellow-400 rounded-full">4</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-purple-400 rounded-full">5</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-purple-500 rounded-full">6</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-purple-600 rounded-full">7</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-purple-700 rounded-full">8</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-purple-800 rounded-full">9</div>
            <div className="inline-block w-full md:w-10/12 h-full bg-purple-900 rounded-full">10</div>
          </div>
        </div>
      </div>
